                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="VD: Chương trình Noel 2024"
                                required
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-48 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                                />
                ...
                <section className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                        <p className="text-sm text-gray-600">
                            ...
                            {prizes.reduce((sum, p) => sum + parseInt(p.default_weight || '0'), 0) !== 100 && (
                                <span className="text-orange-600"> (khuyến nghị = 100%)</span>
                            )}
                        </p>
                    </div>
                </section>
